...
type Listener struct {
	...
	// IP address on which listener serves ant's server
	Ip *wrapperspb.StringValue `protobuf:"bytes,4,opt,name=ip,proto3" json:"ip,omitempty"`
	// Port on which listnter serves ant's server
...
func (x *RevokeListenerRequest) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *RegenerateListenerRequest) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
var file_management_v1_management_proto_rawDesc = []byte{
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x12, 0x32, 0x0a, 0x05, 0x74, 0x6f,
	...
	0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x02, 0x69, 0x64, 0x22, 0x51, 0x0a, 0x1a, 0x52, 0x65,
	...
	0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x2f,
	0x76, 0x31, 0x3b, 0x6d, 0x61, 0x6e, 0x61, 0x67, 0x65, 0x6d, 0x65, 0x6e, 0x74, 0x76, 0x31, 0x62,
